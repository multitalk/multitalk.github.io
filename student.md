...
<div style="display: flex; align-items: flex-start; gap: 20px;margin-top: 20px;margin-bottom: 50px">
  ...
  <div>
    <a href="" class="post-title"><p style="margin: 1.2rem;margin-left: 30px; font-size: 30px; font-family: system-ui;"><strong>付琳凡</strong></p></a>
...
<div style="display: flex; align-items: flex-start; gap: 20px;margin-top: 50px;margin-bottom: 50px">
  ...
  <div>
    <a href="#" class="post-title"><p style="margin: 1.2rem;margin-left: 30px; font-size: 30px; font-family: system-ui;"><strong>王小天</strong></p></a>
...
<div style="display: flex; align-items: flex-start; gap: 20px;margin-top: 50px;margin-bottom: 50px">
  ...
  <div>
    <a href="" class="post-read-more"><p style="margin: 1.2rem;margin-left: 30px; font-size: 30px; font-family: system-ui;"><strong>刘柠溪</strong></p></a>
    <p style="margin: 1.2rem;margin-left: 30px; font-size: 20px; font-family: system-ui">硕士研究生（2025级）</p>
...
<div style="display: flex; align-items: flex-start; gap: 20px;margin-top: 50px;margin-bottom: 50px">
  ...
  <div>
    <a href="#" class="post-title"><p style="margin: 1.2rem;margin-left: 30px; font-size: 30px; font-family: system-ui;color:#6666cc;"><strong>朱芊芊</strong></p></a>
    <p style="margin: 1.2rem;margin-left: 30px; font-size: 20px; font-family: system-ui">硕士研究生（2025级）</p>
