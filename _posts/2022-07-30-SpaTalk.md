...
<div style="text-align: center;padding-top: 20px;padding-bottom: 20px;">
  ...
  <img src="https://raw.githubusercontent.com/ZJUFanLab/SpaTalk/refs/heads/main/img/SpaTalk.png" alt="SpaTalk" style="width: 80%; height: auto;transition: transform 0.3s ease;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'" />
  </a>
</div>
